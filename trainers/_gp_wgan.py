...
class GP_WGAN:
    ...
    def init_wgan(self):
        ...
        elif self.GENERATOR_TYPE == "U-NET":
            self.generator = U_NET().to(self.DEVICE)
        else:
    ...
    def load_weights(self):
        try:
            ...
            print(f"[E] Pretrained weights do not exist at {os.path.join(self.root_dir, self.PRETRAINED_WEIGHTS_PATH)}")
            exit()
